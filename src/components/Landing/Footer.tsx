...
function Footer() {
  return (
    <div className="w-full ">
      ...
      <div className="px-4 py-3 text-text md:px-8 md:py-5 md:flex md:flex-col md:gap-y-1 xl:gap-y-0 xl:py-2">
        ...
        <p className="mt-4 text-base font-semibold md:text-2xl xl:mt-2 xl:text-xl">
